...
public class Bootstrap {
    ...
    public Bank generateTestData() {
        ...
        customerServices.add(c1);
        customerServices.add(c2);
        customerServices.add(c3);
    ...
    public LoginController wireObjects(Bank bank) {
        ...
        CustomerServices customerServices = new CustomerServices(bank, bank.getAccountManager());
        AuthServices authServices = new AuthServices(bank);
        // wire login controller and view
        LoginController loginController = new LoginController();
        LoginView loginView = new LoginView();
        loginController.setView(loginView);
        loginController.setBank(bank);
        loginController.setAuthServices(authServices);
        loginController.setCustomerServices(customerServices);
        loginView.setLoginController(loginController);
        loginView.setPrompt(prompt);

        //wire customerServices
